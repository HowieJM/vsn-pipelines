...
**This fork contains minimal but critical changes enabling SCENIC multirun aggregation with modern cisTarget motif resources (v10), via support for feather v2–based databases, and efficient parallel execution.**
